	jQuery(document).ready(function($){
				...
				function reloadCaptcha(){ $("#captchax").attr("src","./assets/plugins/smart-form/contact/php/captcha/captcha.php?r=" + Math.random()); }
				...
				$( "#smart-form" ).validate({
						...
						rules: {
								...
								captcha:{
									required:true,
									remote:'./assets/plugins/smart-form/contact/php/captcha/process.php'
								}
						},
						messages:{
								sendername: {
